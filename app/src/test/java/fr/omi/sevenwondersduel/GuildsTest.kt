...
class GuildsTest {
    ...
    fun merchant_guild_gives_1_coins_per_commercial_buildings_in_city_which_has_the_most() {
        var game = Game(structure = Game.createStructure(Age.AGE_III, listOf(MERCHANTS_GUILD)), players = Pair(
    ...
    fun shipowner_guild_gives_1_coins_per_material_buildings_in_city_which_has_the_most() {
        var game = Game(structure = Game.createStructure(Age.AGE_III, listOf(SHIPOWNERS_GUILD)), players = Pair(
    ...
    fun magistrates_guild_gives_1_coins_per_civilian_buildings_in_city_which_has_the_most() {
        var game = Game(structure = Game.createStructure(Age.AGE_III, listOf(MAGISTRATE_GUILD)), players = Pair(
    ...
    fun scientists_guild_gives_1_coins_per_scientific_buildings_in_city_which_has_the_most() {
        var game = Game(structure = Game.createStructure(Age.AGE_III, listOf(SCIENTISTS_GUILD)), players = Pair(
    ...
    fun tacticians_guild_gives_1_coins_per_military_buildings_in_city_which_has_the_most() {
        var game = Game(structure = Game.createStructure(Age.AGE_III, listOf(TACTICIANS_GUILD)), players = Pair(

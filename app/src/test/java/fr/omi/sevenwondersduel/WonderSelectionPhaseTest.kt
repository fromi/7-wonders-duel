...
class WonderSelectionPhaseTest {
    ...
    fun last_4_wonders_selection() {
        ...
        game = game.take(TheStatueOfZeus)
        ...
        game = game.take(TheGreatLibrary)
        ...
        game = game.take(TheTempleOfArtemis)

...
class CivilianVictoryTest {
    ...
    fun count_civilian_buildings() {
        ...
        assertThat(AGE_I.buildings.sumBy { civilianVictoryPoint(it) }).isEqualTo(9)
        assertThat(AGE_II.buildings.sumBy { civilianVictoryPoint(it) }).isEqualTo(22)
        assertThat(AGE_III.buildings.sumBy { civilianVictoryPoint(it) }).isEqualTo(36)
    }
    ...
    fun count_scientific_buildings() {
        ...
        assertThat(AGE_I.buildings.sumBy { scientificVictoryPoint(it) }).isEqualTo(2)
        assertThat(AGE_II.buildings.sumBy { scientificVictoryPoint(it) }).isEqualTo(6)
        assertThat(AGE_III.buildings.sumBy { scientificVictoryPoint(it) }).isEqualTo(10)
    }
    ...
    fun count_commercial_buildings() {
        ...
        assertThat(AGE_I.buildings.sumBy { commercialVictoryPoint(it) }).isEqualTo(0)
        assertThat(AGE_II.buildings.sumBy { commercialVictoryPoint(it) }).isEqualTo(0)
        assertThat(AGE_III.buildings.sumBy { commercialVictoryPoint(it) }).isEqualTo(15)
    }
    ...
    fun in_case_of_tie_most_points_from_civilian_building_wins() {
        val game = SevenWondersDuel(conflictPawnPosition = 1, structure = Structure(age = 3, list = emptyList()), players = Pair(

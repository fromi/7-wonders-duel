...
class ConflictPawnView(private val gameActivity: GameActivity, position: Int) : ImageView(gameActivity) {
    init {
        id = generateViewId()
    ...
    private fun putAt(position: Int) {
        ConstraintSet().apply {
            clone(gameActivity.layout)
